...
public class Day16DynamicProgrammingWithMaps implements IPuzzle {
    ...
    private static Map<Integer,Integer> calculateBestPressureRelievedPerOpenedValveBitsetMapFor1Actor(final int[][] distanceBetweenValves, final int[] flowRates, final int startIndex, final boolean considerStartingValve, final int availableTime) {
        ...
        final Map<Integer,Integer> bestPressureRelievedPerOpenedValveBitsetMapFor1Actor = new HashMap<>();
        ...
        while ((oldState = pendingStates.pollFirst()) != null) {
            ...
            bestPressureRelievedPerOpenedValveBitsetMapFor1Actor.merge(openedValveBitset,pressureRelieved+((availableTime-timeElapsed)*pressureReliefRate),Math::max);
    ...
    private static Map<Integer,Integer> calculateBestPressureRelievedPerOpenedValveBitsetMapForNActors(final Map<Integer,Integer> bestPressureRelievedPerOpenedValveBitsetMapForOneActor, final int maximumActorCount) {
        Map<Integer,Integer> bestPressureRelievedPerOpenedValveBitsetMapForNMinusOneActors = bestPressureRelievedPerOpenedValveBitsetMapForOneActor;
        for (int actorCount=2; actorCount<=maximumActorCount; actorCount++) {
            final Map<Integer, Integer> bestPressureRelievedPerOpenedValveBitsetMapForNActors = new HashMap<>();
            for (Map.Entry<Integer, Integer> bestPressureRelievedPerOpenedValveBitsetMapForNMinusOneActorsEntry : bestPressureRelievedPerOpenedValveBitsetMapForNMinusOneActors.entrySet()) {
                final int nMinusOneActorsOpenedValveBitset = bestPressureRelievedPerOpenedValveBitsetMapForNMinusOneActorsEntry.getKey();
                final int nMinusOneActorsBestPressureRelieved = bestPressureRelievedPerOpenedValveBitsetMapForNMinusOneActorsEntry.getValue();
                for (Map.Entry<Integer, Integer> bestPressureRelievedPerOpenedValveBitsetMapForOneActorEntry : bestPressureRelievedPerOpenedValveBitsetMapForOneActor.entrySet()) {
                    final int oneActorsOpenedValveBitset = bestPressureRelievedPerOpenedValveBitsetMapForOneActorEntry.getKey();
                    if ((nMinusOneActorsOpenedValveBitset & oneActorsOpenedValveBitset) == 0) {
                        final int oneActorsBestPressureRelieved = bestPressureRelievedPerOpenedValveBitsetMapForOneActorEntry.getValue();
                        bestPressureRelievedPerOpenedValveBitsetMapForNActors.merge(nMinusOneActorsOpenedValveBitset | oneActorsOpenedValveBitset, nMinusOneActorsBestPressureRelieved + oneActorsBestPressureRelieved, Math::max);
                    }
                }
            }
    ...
    private static int calculateBestPressureRelieved(final Map<Integer,Integer> bestPressureRelievedPerOpenedValveBitsetMapForNActors) {
        return bestPressureRelievedPerOpenedValveBitsetMapForNActors.values().stream().mapToInt(Integer::intValue).max().getAsInt();
    }
}
